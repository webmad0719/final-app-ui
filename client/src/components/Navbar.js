        ...
        if (this.props.userInSession) {
            return (
                <Navbar bg="light" expand="lg" className="menu">
                    <Navbar.Brand><h1>Roler Coasters App</h1></Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ml-auto">
                            ...
                            <Nav.Link as="div"><small>Bienvenid@, {saludo}</small></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
            )
                ...
                <Navbar bg="light" expand="lg" className="menu">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ml-auto">
                            ...
                            <Nav.Link as="div"><Link to="/login">Acceder</Link></Nav.Link>
                            <Nav.Link as="div"><small>Bienvenid@, {saludo}</small></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
